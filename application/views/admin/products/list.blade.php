			...
			<tr>
				...
				<td>
					...
					<div class="btn-group">
						...
						<a class="btn btn-danger" data-toggle="modal" data-id="{{$category->id}}" href="#del-confirmation" onclick="$('#category-id').val($(this).data('id'))" title="Delete category">
			...
			<tr>
				...
				<td>
					<div class="btn-group">
						...
						<a href="{{ URL::to_action('admin.categories@edit', array($product->id)) }}" class="btn btn-small" title="Edit product">
							<i class="icon-edit"></i>
						</a>
						<a class="btn btn-danger" data-toggle="modal" data-id="{{$product->id}}" href="#del-confirmation" onclick="$('#product-id').val($(this).data('id'))" title="Delete product">
							<i class="icon-remove icon-white"></i>
						</a>
					</div></td>
			</tr>
